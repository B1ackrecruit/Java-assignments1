    ...
    */
    ...
    public List<TableEntry> getTableSortedByName(){
        ...
        entries.sort(new Comparator<TableEntry>(){
            ...
            public int compare(TableEntry te1, TableEntry te2) {
                int result = te1.getTeam().getName().compareTo(te2.getTeam().getName());
                return result;	
            }
        });
        return Collections.unmodifiableList(entries);
    ...
    public List<TableEntry> getTableSortedByGoalDifference(){
        ...
        entries.sort(new Comparator<TableEntry>(){
            ...
            @Override
            public int compare(TableEntry te1, TableEntry te2) {
                int result = Integer.compare(te2.getGoalDifference(), te1.getGoalDifference());
                return result;	
            }
        });
        return Collections.unmodifiableList(entries);
    ...
    public List<TableEntry> getTableSortedByGoalsFor(){
        ...
        entries.sort(new Comparator<TableEntry>(){
            ...
            @Override
            public int compare(TableEntry te1, TableEntry te2) {
                int result = Integer.compare(te2.getGoalsFor(), te1.getGoalsFor());
                return result;	
            }
        });
        return Collections.unmodifiableList(entries);

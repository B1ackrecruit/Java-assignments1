...
public class Team {
    ...
    public Team(String name){
        ...
        //Team.contains throws a IllegalArgumentException if name is null or empty
    ...
    public static Team getTeam(String name){
        //TODO: Implementieren Sie die Methode entsprechend des JavaDocs 
        //getKeyByName throws a IllegalArgumentException if name is null or empty
        Team team = teams.get(Helper.getKeyByName(name));
        if(team==null){
            throw new IllegalArgumentException("No team found for given name");
        }
        return team;
    }
    ...
    public static void removeTeam(String name){
        //TODO: Implementieren Sie die Methode entsprechend des JavaDocs
        teams.remove(Helper.getKeyByName(name));
    }
